...
{
    /// <summary>
    /// Finds all <see cref="MessagePart"/>s which are considered to be inline images
    /// </summary>
    internal class InlineImageFinder : MultipleMessagePartFinder
    {
