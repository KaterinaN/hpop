...
{
    internal class FindFirstMessagePartExcludingAttachmentsWithMediaType : IQuestionAnswerMessageTraverser<string, MessagePart>
    {
        /// <summary>
        ...
        public MessagePart VisitMessagePart(MessagePart messagePart, string question)
        {
            ...
            if (messagePart.ContentType.MediaType.Equals(question, StringComparison.OrdinalIgnoreCase) && !messagePart.IsAttachment)
                return messagePart;
